...
LABEL name="DCI Analytics" version="0.0.2"
...
CMD ["gunicorn", "wsgi:application", "--reload", "--access-logfile", "-", "--error-logfile", "-", "--log-level", "debug", "--bind", "0.0.0.0:2345", "--timeout", "30", "--control-socket-disable", "--workers", "4", "--worker-class", "gevent", "--worker-connections", "50"]
