...
CMD ["gunicorn", "wsgi:application", "--access-logfile", "-", "--error-logfile", "-", "--log-level", "debug", "--bind", "0.0.0.0:2345", "--timeout", "30", "--workers", "4", "--worker-class", "gevent", "--worker-connections", "50"]
